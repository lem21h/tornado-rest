...
Country = namedtuple('Country', ('name', 'alpha2', 'alpha3', 'numeric', 'apolitical_name'))
...
_records = (
    ...
    Country(u"Antigua and Barbuda", "AG", "ATG", "028", u"Antigua and Barbuda"),
    ...
    Country(u"Bolivia, Plurinational State of", "BO", "BOL", "068", u"Bolivia, Plurinational State of"),
    Country(u"Bonaire, Sint Eustatius and Saba", "BQ", "BES", "535", u"Bonaire, Sint Eustatius and Saba"),
    Country(u"Bosnia and Herzegovina", "BA", "BIH", "070", u"Bosnia and Herzegovina"),
    ...
    Country(u"British Indian Ocean Territory", "IO", "IOT", "086", u"British Indian Ocean Territory"),
    Country(u"Brunei Darussalam", "BN", "BRN", "096", u"Brunei Darussalam"),
    ...
    Country(u"Central African Republic", "CF", "CAF", "140", u"Central African Republic"),
    ...
    Country(u"Cocos (Keeling) Islands", "CC", "CCK", "166", u"Cocos (Keeling) Islands"),
    Country(u"Colombia", "CO", "COL", "170", u"Colombia"),
    Country(u"Comoros", "KM", "COM", "174", u"Comoros"),
    Country(u"Congo", "CG", "COG", "178", u"Congo"),
    Country(u"Congo, Democratic Republic of the", "CD", "COD", "180", u"Congo, Democratic Republic of the"),
    ...
    Country(u"Falkland Islands (Malvinas)", "FK", "FLK", "238", u"Falkland Islands (Malvinas)"),
    ...
    Country(u"French Southern Territories", "TF", "ATF", "260", u"French Southern Territories"),
    ...
    Country(u"Heard Island and McDonald Islands", "HM", "HMD", "334", u"Heard Island and McDonald Islands"),
    ...
    Country(u"Iran, Islamic Republic of", "IR", "IRN", "364", u"Iran, Islamic Republic of"),
    ...
    Country(u"Korea, Democratic People's Republic of", "KP", "PRK", "408", u"Korea, Democratic People's Republic of"),
    ...
    Country(u"Lao People's Democratic Republic", "LA", "LAO", "418", u"Lao People's Democratic Republic"),
    ...
    Country(u"Macedonia, the former Yugoslav Republic of", "MK", "MKD", "807", u"Macedonia, the former Yugoslav Republic of"),
    ...
    Country(u"Micronesia, Federated States of", "FM", "FSM", "583", u"Micronesia, Federated States of"),
    Country(u"Moldova, Republic of", "MD", "MDA", "498", u"Moldova, Republic of"),
    ...
    Country(u"Northern Mariana Islands", "MP", "MNP", "580", u"Northern Mariana Islands"),
    ...
    Country(u"Palestine, State of", "PS", "PSE", "275", u"Palestine"),
    Country(u"Panama", "PA", "PAN", "591", u"Panama"),
    Country(u"Papua New Guinea", "PG", "PNG", "598", u"Papua New Guinea"),
    ...
    Country(u"Russian Federation", "RU", "RUS", "643", u"Russian Federation"),
    Country(u"Rwanda", "RW", "RWA", "646", u"Rwanda"),
    Country(u"Saint Barthélemy", "BL", "BLM", "652", u"Saint Barthélemy"),
    Country(u"Saint Helena, Ascension and Tristan da Cunha", "SH", "SHN", "654", u"Saint Helena, Ascension and Tristan da Cunha"),
    Country(u"Saint Kitts and Nevis", "KN", "KNA", "659", u"Saint Kitts and Nevis"),
    Country(u"Saint Lucia", "LC", "LCA", "662", u"Saint Lucia"),
    Country(u"Saint Martin (French part)", "MF", "MAF", "663", u"Saint Martin (French part)"),
    Country(u"Saint Pierre and Miquelon", "PM", "SPM", "666", u"Saint Pierre and Miquelon"),
    Country(u"Saint Vincent and the Grenadines", "VC", "VCT", "670", u"Saint Vincent and the Grenadines"),
    Country(u"Samoa", "WS", "WSM", "882", u"Samoa"),
    Country(u"San Marino", "SM", "SMR", "674", u"San Marino"),
    Country(u"Sao Tome and Principe", "ST", "STP", "678", u"Sao Tome and Principe"),
    ...
    Country(u"Sint Maarten (Dutch part)", "SX", "SXM", "534", u"Sint Maarten (Dutch part)"),
    ...
    Country(u"South Georgia and the South Sandwich Islands", "GS", "SGS", "239", u"South Georgia and the South Sandwich Islands", ),
    ...
    Country(u"Svalbard and Jan Mayen", "SJ", "SJM", "744", u"Svalbard and Jan Mayen"),
    ...
    Country(u"Syrian Arab Republic", "SY", "SYR", "760", u"Syrian Arab Republic"),
    Country(u"Taiwan, Province of China", "TW", "TWN", "158", u"Taiwan"),
    Country(u"Tajikistan", "TJ", "TJK", "762", u"Tajikistan"),
    Country(u"Tanzania, United Republic of", "TZ", "TZA", "834", u"Tanzania, United Republic of"),
    ...
    Country(u"Trinidad and Tobago", "TT", "TTO", "780", u"Trinidad and Tobago"),
    ...
    Country(u"Turks and Caicos Islands", "TC", "TCA", "796", u"Turks and Caicos Islands"),
    Country(u"Tuvalu", "TV", "TUV", "798", u"Tuvalu"),
    Country(u"Uganda", "UG", "UGA", "800", u"Uganda"),
    Country(u"Ukraine", "UA", "UKR", "804", u"Ukraine"),
    Country(u"United Arab Emirates", "AE", "ARE", "784", u"United Arab Emirates"),
    Country(u"United Kingdom of Great Britain and Northern Ireland", "GB", "GBR", "826", u"United Kingdom of Great Britain and Northern Ireland"),
    Country(u"United States of America", "US", "USA", "840", u"United States of America"),
    Country(u"United States Minor Outlying Islands", "UM", "UMI", "581", u"United States Minor Outlying Islands"),
    Country(u"Uruguay", "UY", "URY", "858", u"Uruguay"),
    Country(u"Uzbekistan", "UZ", "UZB", "860", u"Uzbekistan"),
    Country(u"Vanuatu", "VU", "VUT", "548", u"Vanuatu"),
    Country(u"Venezuela, Bolivarian Republic of", "VE", "VEN", "862", u"Venezuela, Bolivarian Republic of"),
    Country(u"Viet Nam", "VN", "VNM", "704", u"Viet Nam"),
    Country(u"Virgin Islands, British", "VG", "VGB", "092", u"Virgin Islands, British"),
    Country(u"Virgin Islands, U.S.", "VI", "VIR", "850", u"Virgin Islands, U.S."),
